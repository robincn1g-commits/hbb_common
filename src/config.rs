...
pub const RENDEZVOUS_SERVERS: &[&str] = &["10.6.245.60"];
pub const RELAY_SERVERS: &[&str] = &["10.6.245.60"];
pub const RS_PUB_KEY: &str = "owx2R3jJM7MZN5E+0Ex36eOqQbYRoT64xFPt9JaSmDo=";
