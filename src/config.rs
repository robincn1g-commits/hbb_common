...
pub const RENDEZVOUS_SERVERS: &[&str] = &["10.6.245.60:21116"];
pub const RELAY_SERVERS: &[&str] = &["10.6.245.60:21117"];
pub const RS_PUB_KEY: &str = "owx2R3jJMYMZNS5E+0Ex36e0qQbYRoT64xFpT9JaSmDo=";
